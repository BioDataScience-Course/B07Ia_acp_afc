...
<!--% Réalisez le graphique AFC des stations et des espèces sur les deux premiers axes. Utilisez la fonction de placement intelligent des labels avec `repel = TRUE` et définissez un ratio d'aspect du graphique de 0.6. -->

```{r biplotca, fig.width=9, record='RNCS'}
___
```
